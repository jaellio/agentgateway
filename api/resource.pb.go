...
type TLSConfig struct {
	...
	SpiffeAdditionalTrustDomains []string `protobuf:"bytes,10,rep,name=spiffe_additional_trust_domains,json=spiffeAdditionalTrustDomains,proto3" json:"spiffe_additional_trust_domains,omitempty"`
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}
...
func (x *TLSConfig) GetSpiffeAdditionalTrustDomains() []string {
	if x != nil {
		return x.SpiffeAdditionalTrustDomains
	}
	return nil
}
...
func (x *BackendPolicySpec_BackendTLS) GetSpiffeAdditionalTrustDomains() []string {
	if x != nil {
		return x.SpiffeAdditionalTrustDomains
	}
	return nil
...
const file_resource_proto_rawDesc = "" +
	...
	"\x12certificate_source\x18\t \x01(\x0e26.agentgateway.dev.resource.TLSConfig.CertificateSourceR\x11certificateSource\x12E\n" +
	"\x1fspiffe_additional_trust_domains\x18\n" +
	" \x03(\tR\x1cspiffeAdditionalTrustDomains\"O\n" +
	...
	"\beviction\x18\x02 \x01(\v25.agentgateway.dev.resource.BackendPolicySpec.EvictionR\beviction\x1a\x93\x06\n" +
	"\n" +
	"BackendTLS\x12\x17\n" +
	...
	"\x12certificate_source\x18\t \x01(\x0e2I.agentgateway.dev.resource.BackendPolicySpec.BackendTLS.CertificateSourceR\x11certificateSource\x12E\n" +
	"\x1fspiffe_additional_trust_domains\x18\n" +
	" \x03(\tR\x1cspiffeAdditionalTrustDomains\"C\n" +
